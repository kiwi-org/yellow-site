...
public final class OkHttpKit {
	...
	// 默认超时时间
	private static final int CONNECT_TIMEOUT = 20 * 1000;// 默认毫秒,获取连接用
	private static final int READ_TIMEOUT = 3 * 60 * 1000;// 默认毫秒,下载文件用
	private static final int WRITE_TIMEOUT = 20 * 1000;// 默认毫秒,上传文件用
